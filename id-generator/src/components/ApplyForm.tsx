...
const consentCopy =
  "I consent to submission of my details for this identity verification demo. I understand this is a demo, not real KYC or government identity verification.";
